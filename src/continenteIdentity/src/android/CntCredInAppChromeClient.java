...
public class CntCredInAppChromeClient extends WebChromeClient {

    private CordovaWebView webView;
    private String LOG_TAG = "CntCredInAppChromeClient";
    private long MAX_QUOTA = 100 * 1024 * 1024;

    public CntCredInAppChromeClient(CordovaWebView webView) {
        super();
